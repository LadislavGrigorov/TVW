namespace TankWarsGraphics.GameScreens
{
    ...
    public class GamePlayScreen : BaseGameState
    {
        ...
        protected override void LoadContent()
        {
            ...
            MapLayer ground = new MapLayer(TxtMapReader.Load(@"..\..\..\..\SimpleRPGContent\Maps\FinalMap.txt", 1));
            MapLayer obstacles = new MapLayer(TxtMapReader.Load(@"..\..\..\..\SimpleRPGContent\Maps\FinalMap.txt", 2));
            MapLayer buildings = new MapLayer(TxtMapReader.Load(@"..\..\..\..\SimpleRPGContent\Maps\FinalMap.txt", 3));
